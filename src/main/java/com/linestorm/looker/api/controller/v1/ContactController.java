...
@ControllerBind(controllerKey = "/api/contact")
public class ContactController extends UserBaseController{
    ...
    public void getFriendList(){
        ...
        String sql2 = sql_base + "order by cf.created_time DESC limit 3";

        responseData.put("friendList", Db.find(sql1, user.get("user_id")));
        responseData.put("newFriendList", Db.find(sql2, user.get("user_id")));
    ...
    public void getUserInfo(){
        ...
        responseData.put(ResponseCode.CODE, 1);
        responseData.put("blnFriend", ContactFriend.dao.blnFriend(user.getString("user_id"), ac.get("id")+""));
        responseData.put("userInfo", Db.findFirst(SqlKit.sql("user.getUserInfo"), ac.get("id")));
        renderJson(responseData);
    }
    ...
    public void applyFriend(){
        ...
        if(Db.findFirst("select * from contact_relation where apply_user_id=? and confirm_user_id=? and confirmed=0", user.get("user_id"), user_id) == null){
            ...
            responseData.put(ResponseCode.MSG, "已申请！");
        }
        renderJson(responseData);
    }
    ...
    public void confirmFriend(){
        ...
        if(Db.findFirst("select id from contact_friend where user_id=? and friend_id=?"
            ...
            responseData.put(ResponseCode.MSG, "重复操作！");
        }
        responseData.put(ResponseCode.CODE, r? 1:0);
        renderJson(responseData);
    }
    ...
    public void getUserPublicKey(){
        ...
        String sql = "select ui.user_id,ul.login_name,ul.snnumber,ui.public_key\n" +
                ...
                "where ul.login_name =?";
        responseData.put(ResponseCode.DATA, Db.findFirst(sql, loginName).get("public_key"));
        responseData.put(ResponseCode.CODE, 1);
        renderJson(responseData);
    }
    ...
    public void getFriendApplyList(){
        ...
        responseData.put(ResponseCode.LIST, Db.find(sql, user.get("user_id")));
        responseData.put(ResponseCode.CODE, 1);
        renderJson(responseData);
    }
    ...
    public void addUserLike(){
        ...
        if(Db.findFirst("select * from contact_like where user_id=? and iuser_id=?", user.get("user_id"), user_id) == null){
            ...
            responseData.put(ResponseCode.CODE, -2);
            responseData.put(ResponseCode.MSG, "已关注！");
        }
        renderJson(responseData);
    }
