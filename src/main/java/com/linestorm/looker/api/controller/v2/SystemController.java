...
@ControllerBind(controllerKey = "/api/v2/system")
...
//                        System.out.println(content);
    ...
    public void userLogin(){
        ...
        if(code == 1){
            ...
            responseData.put(ResponseCode.DATA, data);
        }
        responseData.put(ResponseCode.CODE, code);
        responseData.put(ResponseCode.MSG, msg.toString());
        renderJson(responseData);
    ...
    public void getUploadToken(){
        responseData.put(ResponseCode.CODE, 1);
        responseData.put(ResponseCode.DATA, Qiniu.dao.getUploadToken(getParaToInt("type", 1)));
        renderJson(responseData);
    }
