package com.linestorm.looker.api.controller.v2;
...
@ControllerBind(controllerKey = "/api/v2/contact")
public class ContactController extends UserBaseController{
    ...
    public void getFriendList(){
        ...
        responseData.put(ResponseCode.LIST, Db.find(sql1, user.get("user_id")));
