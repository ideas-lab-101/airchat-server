package com.linestorm.looker.service.openapi;
...
public class Qiniu {
    ...
    public String getUploadToken(int type){
        //获取7牛的参数
        ...
        switch (type){
            case 1:
                bucket = PropKit.get("qiniu.bucket.topic");
                break;
            case 2:
                bucket = PropKit.get("qiniu.bucket.im");
                break;
            case 3:
                bucket = PropKit.get("qiniu.bucket.bubble");
                break;
        }
    ...
    public String uploadFile(File nFile, String upToken, String prefix){
        String key = prefix+ DateUtils.getLongDateMilliSecond();
